...
accession_re = re.compile(r'^PKB(FI|DS|SR|AB|SM|BS|DO|GM|LB|WF)[0-9][0-9][0-9][0-9][A-Z][A-Z][A-Z][A-Z]$')
test_accession_re = re.compile(
    r'^TST(FI|DS|SR|AB|SM|BS|DO|GM|LB|WF)[0-9][0-9][0-9][0-9]([0-9][0-9][0-9][0-9]|[A-Z][A-Z][A-Z][A-Z])$')
