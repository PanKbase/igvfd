...
def test_constructs_pipeline_initialize_continuous_deployment_pipeline_construct(mocker, pipeline_config):
    ...
    existing_resources.notification.alarm_notification_topic = Topic.from_topic_arn(
        stack,
        'TestAlarmTopic',
        'arn:aws:sns:us-west-2:123456789012:alarm-topic',
    )
                    ...
                    'Actions': [
                        {
                            ...
                            'Configuration': {
                                ...
                                'EnvironmentVariables': "[{\"name\":\"_PROJECT_CONFIG_HASH\",\"type\":\"PLAINTEXT\",\"value\":\"6472c586ff6fd07a9e36fbee4df8d2294827f9aad21c3b794ba8603513e7021d\"}]"
                            },
                            'InputArtifacts': [
                                {
                                    'Name': 'ABC_xyz_Source'
                                ...
                                'RoleArn': {
                                    'Fn::Join': [
                                        ...
                                        [
                                            ...
                                            ':iam::654654139991:role/cdk-hnb659fds-cfn-exec-role-654654139991-us-west-2'
                                        ]
                                    ]
                                },
                                ...
                                'Fn::Join': [
                                    ...
                                    [
                                        'arn:',
                                       {
                                        ...
                                        ':iam::654654139991:role/cdk-hnb659fds-deploy-role-654654139991-us-west-2'
                                    ]
                                ]
                            },
                            'RunOrder': 1
                    ...
                    'Actions': [
                        {
                            ...
                            'Configuration': {
                                ...
                                'EnvironmentVariables': "[{\"name\":\"_PROJECT_CONFIG_HASH\",\"type\":\"PLAINTEXT\",\"value\":\"dcb0156d567324e44aef414d6326b5c016e52f3caebd8209360c9a133486b7c2\"}]"
                            },
                            'InputArtifacts': [
                                {
                                    'Name': 'ABC_xyz_Source'
                                ...
                                'RoleArn': {
                                    'Fn::Join': [
                                        ...
                                        [
                                            ...
                                            ':iam::565393070554:role/cdk-hnb659fds-cfn-exec-role-565393070554-us-west-2'
                                        ]
                                    ]
                                },
                            ...
                            'RoleArn': {
                                'Fn::Join': [
                                    ...
                                    [
                                        ...
                                        ':iam::565393070554:role/cdk-hnb659fds-deploy-role-565393070554-us-west-2'
                                    ]
                                ]
                            },
                            'RunOrder': 1
                                ...
                                'RoleArn': {
                                    'Fn::Join': [
                                        ...
                                        [
                                            ...
                                            ':iam::495599754696:role/cdk-hnb659fds-cfn-exec-role-495599754696-us-west-2'
                                        ]
                                    ]
                                },
                            ...
                            'RoleArn': {
                                'Fn::Join': [
                                    ...
                                    [
                                        ...
                                        ':iam::495599754696:role/cdk-hnb659fds-deploy-role-495599754696-us-west-2'
                                    ]
                                ]
                            },
                            'RunOrder': 2
